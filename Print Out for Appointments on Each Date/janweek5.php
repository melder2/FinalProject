...
<body>
	<div>
		<form method="POST" action="dbadd.php">
            ...
            <a href="http://localhost:81/janweek4.php">Previous Week</a>
		</form>
	</div>
	<br>
	<div>
		<table border="1">
			...
			<tbody>
				<?php
					include('dbconn.php');
					$query=mysqli_query($conn,"select * from `roomschedule` WHERE day_s BETWEEN '2023-01-30' AND '2023-01-31' ORDER BY day_s, room_number");
