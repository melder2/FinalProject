...
<body>
	<div>
		<form method="POST" action="dbadd.php">
            ...
            <a href="http://localhost:81/janweek2.php">Next Week</a>
		</form>
	</div>
	<br>
	<div>
		<table border="1">
			...
			<tbody>
				<?php
					include('dbconn.php');
					$query=mysqli_query($conn,"select * from `roomschedule` WHERE day_s BETWEEN '2023-01-02' AND '2023-01-06' ORDER BY day_s, room_number");
