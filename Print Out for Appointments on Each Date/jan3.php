...
<html>
    <head>
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=1 ORDER BY start_time ASC';
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=2 ORDER BY start_time ASC';
        $result = mysqli_query( $connect, $query );
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=3 ORDER BY start_time ASC';
        $result = mysqli_query( $connect, $query );
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=4 ORDER BY start_time ASC';
        $result = mysqli_query( $connect, $query );
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=5 ORDER BY start_time ASC';
        $result = mysqli_query( $connect, $query );
        ...
        $query = 'SELECT * FROM roomschedule WHERE day_s=20230103 AND room_number=6 ORDER BY start_time ASC';
        $result = mysqli_query( $connect, $query );
