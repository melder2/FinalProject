...
<body>
	<div>
		<form method="POST" action="dbadd.php">
            ...
            <a href="http://localhost:81/janweek1.php">Previous Week</a>
            <a href="http://localhost:81/janweek3.php">Next Week</a>
		</form>
	</div>
	<br>
	<div>
		<table border="1">
			...
			<tbody>
				<?php
					include('dbconn.php');
					$query=mysqli_query($conn,"select * from `roomschedule` WHERE day_s BETWEEN '2023-01-09' AND '2023-01-13' ORDER BY day_s, room_number");
