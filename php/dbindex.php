...
REFERENCE - I used: campcodes.com. Add, Edit, Delete MySQL Table Rows in PHP | CampCodes. 
			...
			Accessed 24 Apr. 2023. for retrieving every appointment from the database. 
...
<body>
	<div>
		<form method="POST" action="dbadd.php">
            ...
            <label>Reason:</label><input type="text" value="<?php echo $row['reason']; ?>" name="reason"><br>
	...
	<div>
		<table border="1">
			...
			<tbody>
				<?php
					include('dbconn.php');
					$query=mysqli_query($conn,"select * from `roomschedule` ORDER BY day_s, room_number");
